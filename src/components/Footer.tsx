...
export const Footer = () => {
    return (
        ...
        <div className="flex items-center gap-3">
          <Image className="rounded" src="/album.png" width={56} height={56} alt="capa album Pink Floyd" />
          <div className="flex flex-col gap-1">
            <strong className="font-normal">The Wall</strong>
            <span className="text-xs text-zinc-400">Pynk Floyd</span>
          </div>
        </div>
        <div className="flex flex-col items-center gap-2">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className=" text-xs text-zinc-500">4:21</span>
          </div>
        </div>
        <div className="flex items-center gap-3">
          <Mic2 size={17}/>
